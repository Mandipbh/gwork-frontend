...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  Widget mainView() {
    final List<Widget> pagesCli = <Widget>[
    ...
    ]; final List<Widget> pagesPro = <Widget>[
      const SelectServiceView(),
      const SetPasswordView(),
      const PersonalInfoView(),
      const PaymentInfoView(),
      ...
      children: [
        Expanded(
          child: PageView(
            ...
            children: MyApp.apkType==UserType.client?pagesCli:pagesPro,
          ),
        ),
        progressView()
      ],
  ...
  Widget progressView() {
    String labelClient = currentPage == 1
                ...
                : currentPage == 4
                    ? tr('client.log_in.sign_up.Paymen_method')
                        : currentPage == 5
                            ...
                            : '';
    String labelProf = currentPage == 1
        ? tr('client.log_in.sign_up.Reason')
        : currentPage == 2
            ? tr('client.log_in.sign_up.Password')
            : currentPage == 3
                ...
                : currentPage == 4
                    ...
                    : currentPage == 5
                        ...
                        : currentPage == 6
                            ? tr('client.log_in.sign_up.Profile_picture')
                            : '';
    return MyApp.apkType==UserType.client?Consumer<SignUpProvider>(
          ...
          children: [
            ...
            previousAndNextButtons(
                ...
                onNextTap: () {
                  ...
                  print("3===$currentPage ${value.nameController.text}");
                  ...
                  } if(currentPage==4)
                  {
                    ...
                    print("1===${value.cardHolderController.text.toString()}");
                  }if(currentPage==5)
                  {
                    ApiClient()
                        .userRegister(
